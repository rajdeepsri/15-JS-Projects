...
form.addEventListener("submit", (e) => {
  //console.log("hello"); if we do this, then it wont get printed since form m server ko submit hota h
  e.preventDefault(); //now default behavious i.e. submit wont occur
  ...
  if (isNaN(value) || value <= 0 || value > 9) {
    loremText.innerHTML = `<p class="result">${text[randomNum]}</p>`;
  } else {
